...
<head>
    ...
    <?php wp_head(); ?>
    <script src="https://kit.fontawesome.com/b64e1ff1b0.js" crossorigin="anonymous"></script>
</head>
<body <?php body_class(); ?>>
    <header>
        <nav class="navbar navbar-expand-md navbar-light menu-shadow px-0">
                    ...
                    <div class="btn-group">
                        <form class="form-horizontal my-2 my-md-0 tainacan-search-form d-none d-md-block" [formGroup]="searchForm" role="form" (keyup.enter)="onSubmit()" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn tainacan-icon tainacan-icon-search form-control-feedback"></span>
                            </div>
                        </form>
        ...
        <nav class="navbar navbar-expand-md navbar-light px-0 menu-belowheader" role="navigation">
            <div class="container-fluid max-large px-0 margin-one-column">
                <!-- Brand and toggle get grouped for better mobile display -->	
                <!-- <a class="navbar-brand d-md-none" href="#"></a> -->
                <button class="navbar-toggler border-0 px-2 pt-2 collapsed" type="button" data-toggle="collapse" data-target="#menubelowHeader" aria-controls="menubelowHeader" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="tainacan-icon tainacan-icon-menu"></span>
                    <span class="tainacan-icon tainacan-icon-close"></span>
                </button>
                <?php
